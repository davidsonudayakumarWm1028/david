  ...
  return (
    <header className="text-center">
      <h1 className="text-4xl sm:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500">
        David's Product Prompt Generator
      </h1>
      <p className="mt-3 text-lg text-gray-400 max-w-3xl mx-auto">
        Turn a product image into a full video ad concept. Get AI-generated scripts, image prompts, and Veo animation prompts in four simple steps.
      </p>
    </header>
  );
};