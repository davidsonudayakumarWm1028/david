          ...
          <li key={step.name} className={`relative ${stepIdx !== steps.length - 1 ? 'pr-8 sm:pr-20' : ''}`}>
            {stepIdx < currentStep ? (
              <>
                ...
                <div
                  className="relative flex h-9 w-9 items-center justify-center rounded-full bg-purple-600 hover:bg-purple-700"
                >
                  <step.icon />
                </div>
              </>
              ...
              <>
                ...
                <div
                  className="group relative flex h-9 w-9 items-center justify-center rounded-full border-2 border-gray-600 bg-gray-800 hover:border-gray-500"
                >
                   <span className="h-4 w-4 text-gray-500 group-hover:text-gray-400" aria-hidden="true" >
                    <step.icon />
                  </span>
                </div>
              </>
